...
(declaim (ftype (function (chord) pcs:pc-set) chord-pc-set))
(defun chord-pc-set (chord)
  (pcs:set-transpose (quality-pc-set (chord-quality chord))
		     (chord-root chord)))
...
(defun chord-pcs (chord &optional (inversion 0))
